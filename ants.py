...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while curr_place != beehive:
            if curr_place.bees and curr_place_value >= self.min_range and curr_place_value <= self.max_range:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 5
        curr_place = self.place
        bees_list = list(curr_place.bees)
...
# The WallAnt class
class WallAnt(Ant):
    """WallAnt protects the colony with its high armor value"""
...
class ScubaThrower(ThrowerAnt):
    """An underwater version of the ThrowerAnt class"""
    name = 'Scuba'
    is_watersafe = True
    food_cost = 6
    implemented = True
...
# END Problem EC
    ...
    def __init__(self, armor=1):
        ...
        self.queen_number = QueenAnt.queen_counter
    ...
    def action(self, gamestate):
        ...
        while curr_place is not None:
            if curr_place.ant:
                if not curr_place.ant.damage_doubled:
    ...
    def remove_from(self, place):
        if self.queen_number:
            Ant.remove_from(self,self.place) 
